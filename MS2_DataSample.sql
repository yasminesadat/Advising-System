...
-- Adding 10 records to the Advisor table     CHANGED advisor_name to name
...
INSERT INTO Graduation_Plan (semester_code, semester_credit_hours, expected_grad_date, student_id, advisor_id) VALUES --CHANGE to grad_date
...
INSERT INTO Payment (amount, start_date,n_installments, status, fund_percentage, student_id, semester_code, deadline)  VALUES  --CHANGE start_date
...
( 10,'2023-11-30', 58, 'Paid','2023-12-30'); --CHANGE start_date