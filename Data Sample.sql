...
-- Adding 8 records to the Semester table
...
-- Adding 7 records to the Student_Phone table
...
-- Adding 9 records to the PreqCourse_course table
...
INSERT INTO Graduation_Plan (semester_code, semester_credit_hours, expected_grad_date, student_id, advisor_id) VALUES --expected_grad_date not semester
